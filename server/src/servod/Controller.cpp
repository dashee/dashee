 ...
 */
void Controller::setLockConfig(dashee::Threads::Lock * lockConfig)
{
    if (lockConfig == NULL)
 ...
 * @throws dashee::Exception if the pointer is NULL
 */
void Controller::setLockServer(dashee::Threads::Lock * lockServer)
{
    if (lockServer == NULL)
        throw dashee::Exception("Lock param cannot be NULL");
 ...
 * @throws dashee::Exception if the pointer is NULL
 */
void Controller::setLockServoController(
 ...
 * @throws dashee::Exception if the pointer is NULL
 */
void Controller::setLockVehicle(dashee::Threads::Lock * lockVehicle)
{
    if (lockVehicle == NULL)
        throw dashee::Exception("Lock param cannot be NULL");
 ...
 */
void Controller::setConfig(dashee::Config * config)
{
    if (config == NULL)
 ...
 */
dashee::Config * Controller::getConfig()
{
    return this->config;
}
 ...
 */
void Controller::setServer(dashee::Server * server)
{
    if (server == NULL)
 ...
 */
dashee::Server * Controller::getServer()
{
    return this->server;
}
 ...
 */
void Controller::setServoController(dashee::ServoController * servoController)
{
 ...
 */
dashee::ServoController * Controller::getServoController()
{
 ...
 */
void Controller::setVehicle(dashee::Vehicle * vehicle)
{
    if (vehicle == NULL)
 ...
 */
dashee::Vehicle * Controller::getVehicle()
{
    return this->vehicle;
}
 ...
 */
void Controller::loadServoController()
{
 ...
 */ 
void Controller::reloadServoController()
{
...
const char * Controller::SERVOCONTROLLER_DEVICE = "/dev/ttyAMA0";
const unsigned int Controller::SERVOCONTROLLER_TYPE = 1u;
const unsigned int Controller::SERVOCONTROLLER_CHANNELS = 6u;

// Initilize our constants for CONFIG
const char * Controller::CONFIG = "./etc/dashee/servod.conf";

// Initilize our constants for SERVER
const unsigned int Controller::SERVER_PORT = 2047u;
const unsigned int Controller::SERVER_TIMEOUT = 2u;

// Initilize our constants for VEHICLE
const char * Controller::VEHICLE_TYPE = "Car";
